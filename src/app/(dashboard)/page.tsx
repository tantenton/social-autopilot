  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-[rgb(var(--color-text-muted))]">Summary of your social autopilot performance.</p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card className="rounded-xl shadow-sm border-[rgb(var(--color-border))]">
          <CardContent className="p-5">
            <div className="text-xs uppercase tracking-wider text-[rgb(var(--color-text-muted))] font-semibold">Connected Platforms</div>
        ...
        <Card className="rounded-xl shadow-sm border-[rgb(var(--color-border))]">
          <CardContent className="p-5">
            <div className="text-xs uppercase tracking-wider text-[rgb(var(--color-text-muted))] font-semibold">Posts Today</div>
            <div className="mt-2 text-3xl font-bold">2</div>
            <div className="mt-1 text-sm text-[rgb(var(--color-text-muted))]">Scheduled automatically</div>
          </CardContent>
        </Card>
        <Card className="rounded-xl shadow-sm border-[rgb(var(--color-border))]">
          <CardContent className="p-5">
            <div className="text-xs uppercase tracking-wider text-[rgb(var(--color-text-muted))] font-semibold">Next Schedule</div>
            <div className="mt-2 text-xl font-bold">14:00</div>
            <div className="mt-1 text-sm text-[rgb(var(--color-text-muted))]">New product promo</div>
          </CardContent>
        </Card>
      </div>
      ...
      <section aria-label="Quick actions">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link href="/content" className="inline-flex items-center gap-2 rounded-lg border border-[rgb(var(--color-border))] bg-[rgb(var(--color-surface))] px-4 py-3 text-sm font-medium shadow-sm hover:bg-[rgb(var(--color-bg))] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgb(var(--color-primary))] focus-visible:ring-offset-2">
            <ArrowRight size={16} aria-hidden="true" /> View Content
          </Link>
        </div>
      </section>
    </div>
